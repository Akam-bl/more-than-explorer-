...
class AppSettings:
    ...
    scan_history: List[str] = field(default_factory=list)  # История сканирования
...
class FolderScannerApp(QMainWindow):
    ...
    def create_main_widgets(self):
        """Создание основных виджетов - ИСПРАВЛЕНО для отображения истории"""
        # Комбобокс для папок
        ...
        # ПРОСТОЙ СТИЛЬ - убираем всё лишнее
        ...
        # Если есть основная папка и её нет в истории, добавляем
...
📜 В истории файлов: {len(self.settings_manager.settings.file_history)}"""
    ...
    def load_folder_history(self):
        """Загрузка истории папок - УПРОЩЕНО"""
        # Просто обновляем комбобокс если нужно
        pass
