...
class FolderScannerApp(QMainWindow):  # Убедитесь, что имя класса правильное!
    def __init__(self):
        super().__init__()
    ...
    def init_variables(self):
        ...
        self.dark_mode = self.settings.get("dark_mode", False)  # Вот здесь инициализируется!
    ...
    def create_menu(self):
        ...
        self.auto_load_textures_action = QAction("Автозагрузка текстур", self, checkable=True)
        self.auto_load_textures_action.setChecked(self.settings.get("auto_load_textures", False))
        self.auto_load_textures_action.triggered.connect(self.on_auto_load_textures_changed)
        self.auto_load_textures_action.setToolTip("Автоматически загружать текстуры при просмотре")
        special_menu.addAction(self.auto_load_textures_action)
        ...
        self.dark_mode_action = QAction("Тёмная тема", self, checkable=True)  # Убедитесь, что здесь правильное имя!
        self.dark_mode_action.setChecked(self.dark_mode)  # Исправлено: было self.dark.mode
    ...
    def on_auto_load_textures_changed(self):
        ...
        self.settings["auto_load_textures"] = self.auto_load_textures_action.isChecked()
        self.save_settings()
...
def main():
    ...
    window = FolderScannerApp()  # Убедитесь, что здесь правильное имя класса!
    window.show()
